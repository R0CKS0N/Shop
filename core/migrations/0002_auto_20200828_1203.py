# Generated by Django 2.2.15 on 2020-08-28 06:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='item',
            name='image',
            field=models.ImageField(default='rtre', upload_to=''),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='item',
        ...
        migrations.AddField(
            model_name='item',
            name='price',
            field=models.FloatField(default=3434),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='item',
            name='slug',
            field=models.SlugField(default='ro'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='item',
            name='title',
            field=models.CharField(default='to', max_length=100),
            preserve_default=False,
        ),
        migrations.CreateModel(
            name='UserProfile',
